    ...
    json!({
        ...
        "properties": {
            ...
            "health": {"oneOf":[
                ...
                {"type":"object", "additionalProperties":false, "required":["type","url","timeoutMs","startupDeadlineMs","expect"], "properties":{"type":{"const":"http-json"},"url":{"type":"string","description":"Loopback http:// URL."},"timeoutMs":{"type":"integer","minimum":1},"startupDeadlineMs":{"type":"integer","minimum":1},"expect":{"type":"object","minProperties":1,"description":"Stable readiness fields; any mismatch fails health.","additionalProperties":{"type":["string","number","integer","boolean","null"]}},"diagnosticExpect":{"type":"object","minProperties":1,"description":"Optional volatile identity fields; mismatches remain healthy and are reported in health detail.","additionalProperties":{"type":["string","number","integer","boolean","null"]}}}}
            ]},
